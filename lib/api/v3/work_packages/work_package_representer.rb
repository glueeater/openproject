  ...
  module V3
    module WorkPackages
      class WorkPackageRepresenter < Roar::Decorator
        ...
        link :self do
          { href: "#{root_url}api/v3/work_packages/#{represented.model.id}", title: "#{represented.subject}" }
        end

        link :author do
          {
              href: "#{root_url}/api/v3/users/#{represented.model.author.id}",
        ...
        link :responsible do
          {
              href: "#{root_url}/api/v3/users/#{represented.model.responsible.id}",
        ...
        link :assignee do
          {
              href: "#{root_url}/api/v3/users/#{represented.model.assigned_to.id}",
        ...
        link :availableWatchers do
            {
                href: "#{root_url}api/v3/work_packages/#{represented.model.id}/available_watchers",
        ...
        link :watch do
          {
              href: "#{root_url}/api/v3/work_packages/#{represented.model.id}/watchers",
              method: :post,
        ...
        link :unwatch do
          {
              href: "#{root_url}/api/v3/work_packages/#{represented.model.id}/watchers/#{@current_user.id}",
              method: :delete,
        ...
        link :addWatcher do
          {
              href: "#{root_url}/api/v3/work_packages/#{represented.model.id}/watchers{?user_id}",
              method: :post,
              title: 'Add watcher',
              templated: true
        ...
        property :start_date, getter: -> (*) { model.start_date }, render_nil: true
        property :due_date, getter: -> (*) { model.due_date }, render_nil: true
